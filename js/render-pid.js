/**
 * render-pid.js — tanpa panel TF dan Analisis Aksi Kontrol
 */
const RenderPID = (() => {
  ...
  function resetAll() {
    ...
    document.getElementById('pid-param-box').innerHTML = `<div class="result-empty">— Belum ada data —</div>`;
    document.getElementById('pid-chart-card').style.display = 'none';
    const s = document.getElementById('pid-analysis-summary');
    const g = document.getElementById('pid-suggestion');
    if (s) s.innerHTML = '';
    if (g) g.innerHTML = '';
  }
